...
arch=$(uname -m)
if [[ "$arch" == "x86_64" ]]; then
    ipfsdistr="https://github.com/ipfs/kubo/releases/download/v0.38.1/kubo_v0.38.1_linux-amd64.tar.gz"
    ...
    ipfsdistr="https://github.com/ipfs/kubo/releases/download/v0.38.1/kubo_v0.38.1_linux-arm64.tar.gz"
