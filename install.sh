...
arch=$(uname -m)
if [[ "$arch" == "x86_64" ]]; then
    ipfsdistr="https://github.com/ipfs/kubo/releases/download/v0.38.0/kubo_v0.38.0_linux-amd64.tar.gz"
    ...
    ipfsdistr="https://github.com/ipfs/kubo/releases/download/v0.38.0/kubo_v0.38.0_linux-arm64.tar.gz"
...
sudo dpkg -i --force-all $libssl1
wget -O temp/monolith $monolithdistr
